...
![lab-diagram](images/sr-bgp-lu.png)
...
Notice the IGP ECMP aware behaviour with the two paths available to reach the xrd-3 ASBR node. Finally you can notice the mposed label stack `labels imposed {16003 16006}`.
