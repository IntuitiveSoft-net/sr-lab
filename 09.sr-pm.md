...
```
Tue Jan 10 09:33:24.180 CET
segment-routing
 traffic-eng
  policy latency-bound
   color 9182 end-point ipv4 34.34.34.34
   candidate-paths
    preference 100
     dynamic
      metric
...
Color: 9182, End-point: 34.34.34.34
  Name: srte_c_9182_ep_34.34.34.34
  Status:
    Admin: up  Operational: up for 00:01:53 (since Jan 10 09:31:40.395)
  Candidate-paths:
    Preference: 100 (configuration) (active)
      Name: latency-bound
      Requested BSID: dynamic
      ...
      Constraints:
        Protection Type: protected-preferred
        Maximum SID Depth: 10
        Latency Metric Bound: 8000
      Dynamic (valid)
        Metric Type: IGP,   Path Accumulated Metric: 110
        Number of K-shortest-paths: 8
        TE Cumulative Metric: 110
        IGP Cumulative Metric: 110
        Cumulative Latency: 3079
        Hop count: 2
          16146 [Prefix-SID, 46.46.46.46]
          24014 [Adjacency-SID, 20.34.46.46 - 20.34.46.34]
  Attributes:
    Binding SID: 24019
    Forward Class: Not Configured
    Steering labeled-services disabled: no
