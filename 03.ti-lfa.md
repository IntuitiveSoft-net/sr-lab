...
```
```
RP/0/RP0/CPU0:xrd-1#show isis fast-reroute 3.3.3.3/32 detail 
Wed Nov  2 16:33:36.752 UTC
...
```
RP/0/RP0/CPU0:xrd-1#sh mpls forwarding labels 24000 detail 
...
The IPv4 protected adjacency-SID for the adjacency to XRv-3 is 24002 in the output. Notice that the MPLS forwarding entry of the adjacency-SID shows the primary path and the backup path. The backup path for an adjacency-SID steers the traffic to the remote end of the link. 
```
RP/0/RP0/CPU0:xrd-1#sh mpls forwarding labels 24000
...
Configure IGP metric 50 between xrd-5 and xrd-6
