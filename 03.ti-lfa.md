...
:warning: We don't want to modify the TE cost of the link. If not set IOSXR will replicate IGP cost in TE cost. We will modify TE value to `5`. It will be used later on.
