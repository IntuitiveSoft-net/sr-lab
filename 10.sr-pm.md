...
segment-routing
 traffic-eng
  policy to-xrd2-latency
   color 500 end-point ipv4 2.2.2.2
   candidate-paths
    preference 100
     dynamic
      pcep
...
Color: 500, End-point: 2.2.2.2
  Name: srte_c_500_ep_2.2.2.2
  Status:
...
segment-routing
 traffic-eng
  policy latency-bound
   color 501 end-point ipv4 2.2.2.2
   candidate-paths
    preference 100
     dynamic
      metric
...
Color: 501, End-point: 2.2.2.2
  Name: srte_c_501_ep_2.2.2.2
  Status:
